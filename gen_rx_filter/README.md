...
### Split Remez (real and imaginary parts trained separately)

```bash
python3 gen_rx_filter/run_eqz_lowpass_remez_split.py
python3 gen_rx_filter/run_eqz_lowpass_remez_split.py --N 95
```

Output → `gen_rx_filter/figure/eqz_lowpass_remez_split/`
